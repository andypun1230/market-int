...
class TimeframeSignalServiceTests(unittest.TestCase):
    ...
    def test_stock_analysis_aggregate_attaches_signal_payload(self) -> None:
        ...
        with (
            ...
            patch("app.services.stock_analysis_aggregate.calculate_rs_score", return_value=FakeModel(symbol="NVDA")),
            patch("app.services.stock_analysis_aggregate.calculate_stock_rating", return_value=FakeModel(symbol="NVDA")),
