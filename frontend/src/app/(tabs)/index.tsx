...
const styles = StyleSheet.create({
  ...
  biasLabel: { color: Theme.colors.accent, fontSize: Typography.caption.fontSize, fontWeight: Typography.weights.strong, textTransform: 'uppercase' },
  biasRow: { borderTopColor: Theme.colors.border, borderTopWidth: 1, gap: 2, paddingTop: 8 },
  biasText: { color: Theme.colors.text, fontSize: Typography.small.fontSize, lineHeight: 16 },
  ...
  driverText: { color: Theme.colors.text, flex: 1, fontSize: Typography.small.fontSize, lineHeight: 16 },
  emptyText: { color: Theme.colors.textMuted, fontSize: Typography.control.fontSize, lineHeight: 18 },
  ...
  expandText: { color: Theme.colors.accent, fontSize: Typography.caption.fontSize, fontWeight: Typography.weights.strong },
  eyebrow: { color: Theme.colors.textMuted, fontSize: Typography.caption.fontSize, fontWeight: Typography.weights.strong },
  ...
  indexSymbol: { color: Theme.colors.text, fontSize: Typography.body.fontSize, fontWeight: Typography.weights.strong },
  indexTopRow: { alignItems: 'center', flexDirection: 'row', gap: 8, justifyContent: 'space-between' },
  indexTrend: { color: Theme.colors.textMuted, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.emphasis },
  insightBody: { gap: 2 },
  insightCategory: { color: Theme.colors.accent, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong, textTransform: 'uppercase' },
  insightHeadline: { color: Theme.colors.text, fontSize: Typography.body.fontSize, fontWeight: Typography.weights.strong },
  insightText: { color: Theme.colors.textMuted, fontSize: Typography.small.fontSize, lineHeight: 17 },
  ...
  leadershipValue: { color: Theme.colors.text, fontSize: Typography.body.fontSize, fontWeight: Typography.weights.strong },
  marketEventRow: { alignItems: 'flex-start', flexDirection: 'row', gap: 8 },
  marketEventStack: { gap: 6 },
  marketEventText: { color: Theme.colors.text, flex: 1, fontSize: Typography.small.fontSize, lineHeight: 16 },
  microLabel: { color: Theme.colors.textMuted, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong, textTransform: 'uppercase' },
  ...
  pulseHeadline: { fontSize: Typography.screenTitleSmall.fontSize, fontWeight: Typography.weights.strong, lineHeight: 31 },
  ...
  riskScale: { color: Theme.colors.textMuted, fontSize: Typography.chartLabel.fontSize, marginBottom: 5 },
  riskScore: { color: Theme.colors.text, fontSize: Typography.entityTitle.fontSize, fontWeight: Typography.weights.strong, lineHeight: 30 },
  ...
  updatedText: { color: Theme.colors.textMuted, flexShrink: 1, fontSize: Typography.chartLabel.fontSize, textAlign: 'right' },
  ...
  visualMetricValue: { fontSize: Typography.caption.fontSize, fontWeight: Typography.weights.strong },
});
