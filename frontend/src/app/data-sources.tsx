    ...
    <AppScreen showBackButton title="Data Sources" subtitle="Current data mode and calculation limits.">
      <View style={styles.stack}>
        <DashboardCard title="Current Mode" accentColor={Theme.colors.accent}>
          <View style={styles.stack}>
            <StatusBadge label={testData?.label ?? 'Generated Test Data'} tone="warning" />
        ...
        <InfoCard title="Market Data">
          Market data may be live, delayed, cached, simulated, or unavailable depending on provider configuration.
          Current generated test data is labelled and should not be treated as current market data.
        </InfoCard>
