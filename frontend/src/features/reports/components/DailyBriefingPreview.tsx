...
const styles = StyleSheet.create({
  ...
  body: { color: Theme.colors.text, flex: 1, fontSize: Typography.body.fontSize, lineHeight: 21 },
  ...
  checkLabel: { color: Theme.colors.text, flex: 1, fontSize: Typography.control.fontSize, fontWeight: Typography.weights.strong },
  ...
  checkValue: { color: Theme.colors.textMuted, fontSize: Typography.small.fontSize, fontWeight: Typography.weights.strong },
  ...
  coverNarrative: { color: Theme.colors.text, fontSize: Typography.supportTitle.fontSize, fontWeight: Typography.weights.emphasis, lineHeight: 25, marginTop: Spacing.three },
  date: { color: Theme.colors.textMuted, fontSize: Typography.small.fontSize, fontWeight: Typography.weights.strong, marginTop: Spacing.one },
  disclaimer: { color: Theme.colors.textMuted, fontSize: Typography.caption.fontSize, lineHeight: 17 },
  ...
  fallbackText: { color: Theme.colors.textMuted, flex: 1, fontSize: Typography.control.fontSize, lineHeight: 19 },
  ...
  flowIndexText: { color: Theme.colors.accent, fontSize: Typography.small.fontSize, fontWeight: Typography.weights.strong },
  flowItem: { alignItems: 'flex-start', flexDirection: 'row', gap: Spacing.twoAndHalf },
  itemEyebrow: { color: Theme.colors.textMuted, fontSize: Typography.caption.fontSize, fontWeight: Typography.weights.strong },
  itemTitle: { color: Theme.colors.text, flex: 1, fontSize: Typography.body.fontSize, fontWeight: Typography.weights.strong },
  ...
  metricValue: { color: Theme.colors.text, fontSize: Typography.body.fontSize, fontWeight: Typography.weights.strong, lineHeight: 20 },
  ...
  namedValue: { color: Theme.colors.text, fontSize: Typography.control.fontSize, fontWeight: Typography.weights.strong, lineHeight: 21 },
  ...
  symbol: { color: Theme.colors.accent, fontSize: Typography.control.fontSize, fontWeight: Typography.weights.strong },
  ...
  title: { color: Theme.colors.text, fontSize: Typography.entityTitle.fontSize, fontWeight: Typography.weights.strong, marginTop: Spacing.one },
  transition: { color: Theme.colors.accent, fontSize: Typography.bodyLarge.fontSize, fontWeight: Typography.weights.strong },
