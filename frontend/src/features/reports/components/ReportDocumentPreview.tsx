...
const styles = StyleSheet.create({
  action: { color: Theme.colors.accent, fontSize: Typography.control.fontSize, fontWeight: Typography.weights.strong, lineHeight: 19 },
  body: { color: Theme.colors.text, fontSize: Typography.body.fontSize, lineHeight: 21 },
  ...
  claimText: { color: Theme.colors.text, fontSize: Typography.bodyLarge.fontSize, fontWeight: Typography.weights.strong, lineHeight: 22 },
  ...
  documentTableCell: { color: Theme.colors.text, fontSize: Typography.chartLabel.fontSize, lineHeight: 15, padding: Spacing.one, width: 125 },
  documentTableHeader: { backgroundColor: Theme.colors.text },
  documentTableHeaderCell: { color: Theme.colors.background, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong, padding: Spacing.one, width: 125 },
  ...
  evidenceColumnTitle: { color: Theme.colors.text, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong },
  evidenceContradicts: { backgroundColor: Theme.colors.dangerSoft, borderColor: Theme.colors.danger, borderWidth: 1 },
  evidenceDimension: { color: Theme.colors.text, fontSize: Typography.small.fontSize, fontWeight: Typography.weights.strong },
  evidenceFinding: { color: Theme.colors.text, fontSize: Typography.caption.fontSize, lineHeight: 16 },
  evidenceImplication: { color: Theme.colors.textMuted, fontSize: Typography.chartLabel.fontSize, lineHeight: 15 },
  ...
  eyebrow: { color: Theme.colors.accent, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong },
  ...
  executiveAnswerText: { color: Theme.colors.text, fontSize: Typography.bodyLarge.fontSize, fontWeight: Typography.weights.strong, lineHeight: 22 },
  figure: { borderBottomColor: Theme.colors.border, borderBottomWidth: 1, gap: Spacing.two, paddingVertical: Spacing.three },
  figureMeta: { color: Theme.colors.textMuted, fontSize: Typography.caption.fontSize, lineHeight: 16 },
  ...
  figureQuestionText: { color: Theme.colors.text, fontSize: Typography.small.fontSize, fontWeight: Typography.weights.strong, lineHeight: 17 },
  figureTitle: { color: Theme.colors.text, fontSize: Typography.supportTitle.fontSize, fontWeight: Typography.weights.strong, lineHeight: 21 },
  ...
  focusBadgeTitle: { color: Theme.colors.text, fontSize: Typography.bodyLarge.fontSize, fontWeight: Typography.weights.strong },
  ...
  focusTitle: { color: Theme.colors.text, fontSize: Typography.detailTitle.fontSize, fontWeight: Typography.weights.strong },
  ...
  genericFigureLabel: { color: Theme.colors.text, flex: 1, fontSize: Typography.caption.fontSize, fontWeight: Typography.weights.strong },
  genericFigureNotice: { color: Theme.colors.textMuted, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong, marginBottom: Spacing.one, textTransform: 'uppercase' },
  ...
  genericFigureValue: { color: Theme.colors.textMuted, flex: 2, fontSize: Typography.caption.fontSize, lineHeight: 16 },
  heatCell: { alignItems: 'center', height: 32, justifyContent: 'center', width: 68 },
  heatCellHeader: { color: Theme.colors.textMuted, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong, textAlign: 'center', width: 68 },
  heatLabel: { color: Theme.colors.text, fontSize: Typography.caption.fontSize, fontWeight: Typography.weights.strong, width: 130 },
  heatRow: { alignItems: 'center', flexDirection: 'row', gap: 2 },
  heatValue: { color: '#101828', fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong },
  heatmap: { gap: 2, paddingVertical: Spacing.two },
  label: { color: Theme.colors.textMuted, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong },
  ...
  legendText: { color: Theme.colors.textMuted, fontSize: Typography.chartAxis.fontSize, fontWeight: Typography.weights.emphasis },
  listStack: { gap: Spacing.three, marginTop: Spacing.two },
  meta: { color: Theme.colors.textMuted, fontSize: Typography.small.fontSize, fontWeight: Typography.weights.emphasis },
  ...
  muted: { color: Theme.colors.textMuted, fontSize: Typography.small.fontSize, lineHeight: 18 },
  posture: { color: Theme.colors.success, fontSize: Typography.control.fontSize, fontWeight: Typography.weights.strong, marginTop: Spacing.one },
  pressed: { opacity: 0.7 },
  ...
  priorityLabel: { color: Theme.colors.textMuted, fontSize: Typography.caption.fontSize, width: 120 },
  priorityLabelSelected: { color: Theme.colors.text, fontWeight: Typography.weights.strong },
  ...
  relativeFlowValue: { fontSize: Typography.caption.fontSize, fontWeight: Typography.weights.strong, textAlign: 'right', width: 48 },
  ...
  researchChainArrow: { color: Theme.colors.accent, fontSize: Typography.sectionTitle.fontSize, fontWeight: Typography.weights.strong, lineHeight: 22 },
  ...
  riskLabel: { color: Theme.colors.danger, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong },
  ...
  rowTitle: { color: Theme.colors.text, fontSize: Typography.body.fontSize, fontWeight: Typography.weights.strong },
  section: { gap: Spacing.two, paddingTop: Spacing.three },
  sectionNumber: { color: Theme.colors.accent, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong },
  sectionPurpose: { color: Theme.colors.textMuted, fontSize: Typography.control.fontSize, lineHeight: 19 },
  ...
  sectionQuestionText: { color: Theme.colors.text, fontSize: Typography.supportTitle.fontSize, fontWeight: Typography.weights.strong, lineHeight: 22 },
  sectionTitle: { color: Theme.colors.text, fontSize: Typography.decisionState.fontSize, fontWeight: Typography.weights.strong, lineHeight: 28 },
  ...
  securitySymbol: { color: Theme.colors.accent, fontSize: Typography.sectionTitle.fontSize, fontWeight: Typography.weights.strong },
  ...
  signalMetric: { color: Theme.colors.textMuted, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong },
  signalRow: { borderTopColor: Theme.colors.border, borderTopWidth: 1, gap: Spacing.one, paddingTop: Spacing.two },
  signalSymbol: { color: Theme.colors.text, fontSize: Typography.control.fontSize, fontWeight: Typography.weights.strong },
  sourceText: { color: Theme.colors.textMuted, fontSize: Typography.chartLabel.fontSize, lineHeight: 15 },
  ...
  summaryValue: { color: Theme.colors.text, fontSize: Typography.body.fontSize, fontWeight: Typography.weights.strong },
  ...
  timelineCell: { color: Theme.colors.text, fontSize: Typography.chartLabel.fontSize, lineHeight: 14, padding: Spacing.one, width: 110 },
  timelineHeader: { color: Theme.colors.background, fontSize: Typography.chartLabel.fontSize, fontWeight: Typography.weights.strong, padding: Spacing.one, width: 110 },
  ...
  title: { color: Theme.colors.text, fontSize: Typography.reportTitle.fontSize, fontWeight: Typography.weights.strong, lineHeight: 30 },
